                                 ...
                                 <tbody>
                                    <tr>
                                       <td style="color: #153643; font-family: Arial, sans-serif;">
                                          <h1 style="font-size: 24px; margin: 0;">Dear {{ $data['name'] }}</h1>
                                       </td>
                                    </tr>
                                    <tr>
                                       <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0;">
                                          <p style="margin: 0;">Please use the following credentials for login as an organizer  on {{ env('APP_NAME') }} App.</p>
